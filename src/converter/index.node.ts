...
// PDFJSWorker import is not properly typed but required for functionality
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import PDFJSWorker from 'pdfjs-dist/legacy/build/pdf.worker';
import { createCanvas } from 'canvas';
import { pdf2img as _pdf2img, Pdf2ImgOptions } from './pdf2img';
import { pdf2size as _pdf2size, Pdf2SizeOptions } from './pdf2size';
