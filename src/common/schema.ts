...
export const Schema = z
  .object({
    ...
    signerId: z.string().optional(), // ID of the signer this field belongs to
  })
  .passthrough();
...
export const Template = z
  .object({
    ...
    // Multi-signature support
    signers: z.array(Signer).optional(), // List of signers for multi-signature documents
    multiSignature: z.boolean().optional(), // Flag to enable multi-signature mode
  })
  .passthrough();
