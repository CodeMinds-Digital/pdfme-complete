import type { UIRenderProps, Mode } from '../../common';
import type { TableSchema, CellStyle, Styles } from './types';
import { px2mm, ZOOM } from '../../common';
import { createSingleTable } from './tableHelper';
import { getBody, getBodyWithRange } from './helper';
...
export const uiRender = async (arg: UIRenderProps<TableSchema>) => {
  ...
  const bodyWidthRange = getBodyWithRange(value, {
