import type { PropPanel } from '../../common';
import type { TableSchema } from './types';
import { getFallbackFontName, DEFAULT_FONT_NAME } from '../../common';
import {
...
export const propPanel: PropPanel<TableSchema> = {
  schema: ({ activeSchema, options, i18n }) => {
    // Casting is safe here because activeSchema is narrowed by context
