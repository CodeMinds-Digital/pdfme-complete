...
const runnersToPage = (
  ...
  async text(element) {
    ...
    const fontCandidate = options.fonts && getBestFont(element.svgAttributes, options.fonts);
    const activeFont: PDFFont = (fontCandidate as unknown as PDFFont) || page.getFont()[0];
    ...
    page.drawText(text, {
      x: -offsetX,
      y: -offsetY,
      font: fontCandidate as unknown as PDFFont | undefined,
  ...
  async ellipse(element) {
    page.drawEllipse({
      ...
      xScale: element.svgAttributes.rx ?? 0,
      yScale: element.svgAttributes.ry ?? 0,
      borderColor: element.svgAttributes.stroke,
      borderWidth: element.svgAttributes.strokeWidth,
      borderOpacity: element.svgAttributes.strokeOpacity,
      borderLineCap: element.svgAttributes.strokeLineCap,
